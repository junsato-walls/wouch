...
function Shift() {
      ...
      <div><TextField id="outlined-basic" label="シフト名" variant="outlined"/></div>
      <div><TextField id="outlined-basic" label="削除フラグ" variant="outlined"/></div>
      <div><TextField id="outlined-basic" label="勤務区分" variant="outlined"/></div>
