...
class t_paymentstable(Base):
    ...
    others_deduction =Column(Integer)
...
class t_payments(BaseModel):
    ...
    others_deduction: Union[int, None] = None
    total_deduction: Union[int, None] = None
    total_pay: Union[int, None] = None
